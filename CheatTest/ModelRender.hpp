...
public:
	...
	i_material* CreateMaterial(const char* pMaterialName, c_key_values* pVMTKeyValues) {
		typedef i_material* (*Fn)(void*, const char*, c_key_values*);
		return utilities::call_virtual<Fn>(this, 83)(this, pMaterialName, pVMTKeyValues);
	}
};
